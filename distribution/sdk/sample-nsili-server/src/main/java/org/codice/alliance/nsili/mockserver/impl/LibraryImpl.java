 ...
 */
package org.codice.alliance.nsili.mockserver.impl;
...
import org.codice.alliance.nsili.mockserver.impl.managers.CatalogMgrImpl;
import org.codice.alliance.nsili.mockserver.impl.managers.DataModelMgrImpl;
import org.codice.alliance.nsili.mockserver.impl.managers.OrderMgrImpl;
import org.codice.alliance.nsili.mockserver.impl.managers.ProductMgrImpl;
...
public class LibraryImpl extends LibraryPOA {
  ...
  private LibraryDescription libraryDescription =
      new LibraryDescription("localhost", "US|AFRL/IFEC", "NSILI|1.0");

  private List<String> manager =
      Arrays.asList("OrderMgr", "CatalogMgr", "ProductMgr", "DataModelMgr" /* Optional :
            "QueryOrderMgr",
            "StandingQueryMgr",
            "CreationMgr",
            "UpdateMgr" */);
  ...
  public LibraryManager get_manager(String manager_type, AccessCriteria access_criteria)
    ...
    switch (manager_type) {
      case "CatalogMgr":
        ...
        try {
          poa_.activate_object_with_id(
              manager_type.getBytes(Charset.forName(ENCODING)), catalogMgr);
        } catch (Exception e) {
          // Ignore
        }
        ...
        obj =
            poa_.create_reference_with_id(
                manager_type.getBytes(Charset.forName(ENCODING)), CatalogMgrHelper.id());
        break;
      ...
      case "OrderMgr":
        ...
        obj =
            poa_.create_reference_with_id(
                manager_type.getBytes(Charset.forName(ENCODING)), OrderMgrHelper.id());
        break;
      ...
      case "ProductMgr":
        ...
        try {
          poa_.activate_object_with_id(
              manager_type.getBytes(Charset.forName(ENCODING)), productMgr);
        } catch (Exception e) {
          // Ignore
        }
        ...
        obj =
            poa_.create_reference_with_id(
                manager_type.getBytes(Charset.forName(ENCODING)), ProductMgrHelper.id());
        break;
      ...
      case "DataModelMgr":
        ...
        try {
          poa_.activate_object_with_id(
              manager_type.getBytes(Charset.forName(ENCODING)), dataModelMgr);
        } catch (Exception e) {
          // Ignore
        }
        ...
        obj =
            poa_.create_reference_with_id(
                manager_type.getBytes(Charset.forName(ENCODING)), DataModelMgrHelper.id());
        break;
