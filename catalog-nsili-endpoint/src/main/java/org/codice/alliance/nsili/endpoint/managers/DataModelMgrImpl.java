...
public class DataModelMgrImpl extends DataModelMgrPOA {
  ...
  private static final AbsTime LAST_UPDATED =
      new AbsTime(
          new Date((short) 2016, (short) 2, (short) 9), new Time((short) 2, (short) 0, (short) 0));
  ...
  @Override
  public String get_logical_attribute_name(
      String view_name, ConceptualAttributeType attribute_type, NameValue[] properties)
      throws InvalidInputParameter, ProcessingFault, SystemFault {
  ...
  public AttributeInformation[] get_attributes(String view_name, NameValue[] properties)
    ...
    AttributeInformation[] attributes =
        nsiliDataModel.getAttributesForView(view_name).toArray(new AttributeInformation[0]);
    return attributes;
  }
