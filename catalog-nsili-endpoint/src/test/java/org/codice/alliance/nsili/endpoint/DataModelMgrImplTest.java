...
public class DataModelMgrImplTest {
  ...
  @Test
  public void testGetAliasCategories() throws InvalidInputParameter, SystemFault, ProcessingFault {
  ...
  public void testGetLogicalAttributeName()
    ...
    String logicalAttr =
        dataModelMgr.get_logical_attribute_name(
            NsiliConstants.NSIL_ALL_VIEW, ConceptualAttributeType.CLASSIFICATION, null);
  ...
  public void testGetAttributes() throws InvalidInputParameter, SystemFault, ProcessingFault {
    AttributeInformation[] attributes =
        dataModelMgr.get_attributes(NsiliConstants.NSIL_ALL_VIEW, null);
  ...
  @Test
  public void testGetEntityAttributes() throws InvalidInputParameter, SystemFault, ProcessingFault {
    AttributeInformation[] attributes =
        dataModelMgr.get_entity_attributes(NsiliConstants.NSIL_CARD, null);
    assertThat(attributes, notNullValue());
  }
  ...
  public void testGetQueryableAttributes()
      throws InvalidInputParameter, SystemFault, ProcessingFault {
    AttributeInformation[] attributes =
        dataModelMgr.get_queryable_attributes(NsiliConstants.NSIL_ALL_VIEW, null);
    assertThat(attributes, notNullValue());
