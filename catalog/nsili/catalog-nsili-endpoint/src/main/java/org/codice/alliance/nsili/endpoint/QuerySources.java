...
public interface QuerySources {
     ...
     * ids in this set.
     *
     * @return {@link org.codice.alliance.nsili.endpoint.NsiliEndpoint#querySources}. Returns an
     * empty Set<String> when no querySources have been added.
     */
     ...
     *
     * @param sourceId to add to the querySources list. sourceId may be null.
     *                 {@link CatalogFramework#getSourceIds()} must contain the sourceId to be added.
     */
