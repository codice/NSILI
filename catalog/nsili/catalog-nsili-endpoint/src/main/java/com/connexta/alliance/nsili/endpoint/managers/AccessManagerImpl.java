...
import com.connexta.alliance.nsili.common.GIAS.AccessManagerPOA;
...
public class AccessManagerImpl extends AccessManagerPOA {
    ...
    public boolean is_available(Product product, String use_mode)
        ...
        if (product != null) {
            ...
            try {
                ...
                com.connexta.alliance.nsili.common.UCO.exception_details exceptionDetails = new com.connexta.alliance.nsili.common.UCO.exception_details();
    ...
    @Override
    public int query_availability_delay(Product product,
