...
public class ProductMgrImplTest extends NsiliTestCommon {
  ...
  public void testIsAvailable() throws Exception {
    ...
    DAG dag =
        ResultDAGConverter.convertResult(
            testResult, orb, rootPOA, new ArrayList<>(), new HashMap<>());
  ...
  public void testGetParameters() throws Exception {
    ...
    DAG dag =
        ResultDAGConverter.convertResult(
            testResult, orb, rootPOA, new ArrayList<>(), new HashMap<>());
    Product product = ProductHelper.extract(dag.nodes[0].value);
    GetParametersRequest parametersRequest =
        productMgr.get_parameters(product, new String[] {"ALL"}, null);
  ...
  public void testGetRelatedFiles() throws Exception {
    ...
    GetRelatedFilesRequest request =
        productMgr.get_related_files(products, location, NsiliConstants.THUMBNAIL_TYPE, props);
